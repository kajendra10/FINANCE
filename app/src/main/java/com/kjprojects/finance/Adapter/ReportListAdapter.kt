...
import com.kjprojects.finance.R
import com.kjprojects.finance.databinding.ViewholderBudgetBinding
...
class ReportListAdapter(private val items:MutableList<BudgetDomain>):RecyclerView.Adapter<ReportListAdapter.Viewholder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val binding=ViewholderBudgetBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: ReportListAdapter.Viewholder, position: Int) {
        ...
        holder.binding.priceTxt.text = "RM"+formatter?.format(item.price)+" /Month"
